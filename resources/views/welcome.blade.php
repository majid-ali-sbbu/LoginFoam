        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <h1 class="h3 m-0 d-flex align-items-center">
                    <i class="fas fa-globe me-2"></i> Wellcome To &nbsp;<span style="color: yellow">Apna Edu.pk</span>
                </h1>
                ...
                <nav class="d-flex align-items-center">
                    ...
                    <a href="#" class="text-white mx-3 text-decoration-none d-flex align-items-center">
